...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Guest Order entity representing a customer order for unregistered users")
public class GuestOrder {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Schema(description = "Unique identifier for the guest order", example = "1")
    private Long id;

    @Column(nullable = false)
    @Schema(description = "Customer name for guest orders", example = "John Doe")
    private String customerName;
    
    @Column(nullable = false)
    @Schema(description = "Customer email for guest orders", example = "john@example.com")
    private String customerEmail;
    
    @Column(nullable = false)
    @Schema(description = "Customer phone for guest orders", example = "+1234567890")
    ...
    @Schema(description = "List of items in the guest order")
    private List<GuestOrderItem> orderItems;
